...
class LinuxHAv2(HeartbeatCM):
    ...
    def __init__(self, Environment, randseed=None):
        ...
        self.update({
            ...
            "IsRscRunning"   : "/usr/lib/heartbeat/lrmadmin -E %s monitor 0 0 EVERYTIME 2>/dev/null|grep return",
            "ExecuteRscOp"   : "/usr/lib/heartbeat/lrmadmin -n %s -E %s %s 0 %d EVERYTIME 2>/dev/null",
