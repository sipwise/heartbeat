...
class Stonithd(ResetMechanism):
    def __init__(self, nodes, sttype = 'external/ssh'):
        ...
        self.query_cmd_pat   = '/usr/lib/heartbeat/stonithdtest/apitest 0 %s 60000 0'
        self.reset_cmd_pat   = '/usr/lib/heartbeat/stonithdtest/apitest 1 %s 60000 0'
        self.poweron_cmd_pat = '/usr/lib/heartbeat/stonithdtest/apitest 2 %s 60000 0'
        self.poweroff_cmd_pat= '/usr/lib/heartbeat/stonithdtest/apitest 3 %s 60000 0'

        self.lrmd_add_pat    = '/usr/lib/heartbeat/lrmadmin -A %s stonith ' + sttype + ' NULL hostlist=%s livedangerously=yes'
        self.lrmd_start_pat  = '/usr/lib/heartbeat/lrmadmin -E %s start 0 0 EVERYTIME'
        self.lrmd_stop_pat   = '/usr/lib/heartbeat/lrmadmin -E %s stop 0 0 EVERYTIME'
...
class CtsLab(UserDict):
    ...
    def SupplyDefaults(self): 
        ...
        if not self.has_key("logrestartcmd"):
            self["logrestartcmd"] = "/etc/init.d/syslog restart"
